...
public class KubernetesService(ILogger<KubernetesService> logger) : IKubernetesService
{
    ...
    /// <summary>
    /// Determines whether [is all namespaces] [the specified ns].
    /// </summary>
    /// <param name="ns">The ns.</param>
    /// <returns>
    ///   <c>true</c> if [is all namespaces] [the specified ns]; otherwise, <c>false</c>.
    /// </returns>
    private bool IsAllNamespaces(string ns) => string.IsNullOrEmpty(ns) || ns == "*";
}
