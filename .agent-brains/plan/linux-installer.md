...
- [ ] **B6 README — apt-source install block** — once B2-B5 are green and a real release has populated the repo, replace the manual-download instructions in the README with the `signed-by` snippet from Part 3 of the guide. Keep the manual `.deb` download as an air-gapped fallback. _Unblocked 2026-06-04 by the v1.3.5 seed._
